...
# save these files
write.table(all_res, "04_DEseq2/DCK_results/EG_all_results_DCK.tsv", sep="\t", quote=F)
all_table %>% round(digits=7) %>% write.table("04_DEseq2/DCK_results/EG_all_results_table_DCK.tsv", sep="\t", quote=F)
```
